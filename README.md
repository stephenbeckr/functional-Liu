...
- Cardot's generalized ridge regression: create the spsd roughness matrix $R \succeq 0$ to penalize large values of curvature (i.e., specialized for data arising from **functional data analysis**), 
